...
struct TestTimestamp: XCTestCase, TailorTestable {
  var allTests: [(String, Void->())] { return [
    ...
    ("testInitializationWithLocalComponentsSetsTimestamp", testInitializationWithLocalComponentsSetsTimestamp),
    ("testInitializationWithLocalComponentsBefore1970SetsTimestamp", testInitializationWithLocalComponentsBefore1970SetsTimestamp),
    ("testInitializationCanHandleJumpAroundDaylightSavingTime", testInitializationCanHandleJumpAroundDaylightSavingTime),
    ("testInTimeZoneWithTimeZoneDoesConversion", testInTimeZoneWithTimeZoneDoesConversion),
    ("testInTimeZoneWithTimeZoneNameDoesConversion", testInTimeZoneWithTimeZoneNameDoesConversion),
    ("testTimeInCalendarConvertsToNewCalendarSystem", testTimeInCalendarConvertsToNewCalendarSystem),
    ("testChangeCanChangeTimeComponents", testChangeCanChangeTimeComponents),
    ("testAddingIntervalCanAddSimpleInterval", testAddingIntervalCanAddSimpleInterval),
    ("testAddingIntervalCanHandleExtraDayInLeapYear", testAddingIntervalCanHandleExtraDayInLeapYear),
    ("testAddingIntervalCanRollOver", testAddingIntervalCanRollOver),
    ("testAddingIntervalCanRollOverYear", testAddingIntervalCanRollOverYear),
    ("testAddingIntervalCanRollBackToPreviousMonth", testAddingIntervalCanRollBackToPreviousMonth),
    ("testAddingIntervalCanAddAndSubtractAtOnce", testAddingIntervalCanAddAndSubtractAtOnce),
    ("testIntervalSinceGetsIntervalSinceEarlierTime", testIntervalSinceGetsIntervalSinceEarlierTime),
    ("testIntervalSinceGetsIntervalUntilLaterTime", testIntervalSinceGetsIntervalUntilLaterTime),
    ("testIntervalSinceWithDifferentTimeZoneCompensatesForTimeZones", testIntervalSinceWithDifferentTimeZoneCompensatesForTimeZones),
    ("testIntervalSinceWithDifferentCalendarCompensatesForCalendar", testIntervalSinceWithDifferentCalendarCompensatesForCalendar),
    ("testIntervalSinceCompensatesForHigherNanoseconds", testIntervalSinceCompensatesForHigherNanoseconds),
    ("testFormatMethodFormatsTime", testFormatMethodFormatsTime),
    ("testDescriptionGetsDatabaseFormattedTime", testDescriptionGetsDatabaseFormattedTime),
    ("testNowMethodGetsCurrentTime", testNowMethodGetsCurrentTime),
    ("testInitWithFoundationDateUsesTimestampFromDate", testInitWithFoundationDateUsesTimestampFromDate),
    ("testFoundationDateCreatesDateWithTimestamp", testFoundationDateCreatesDateWithTimestamp),
    ("testFreezeMethodFreezesCurrentTime", testFreezeMethodFreezesCurrentTime),
    ("testFreezeMethodWithNewValueFreezesAtThatValue", testFreezeMethodWithNewValueFreezesAtThatValue),
    ("testDateCreatesDateWithDateInformation", testDateCreatesDateWithDateInformation),
    ("testTimeCreatesTimeWithTimeInformation", testTimeCreatesTimeWithTimeInformation),
    ("testTimestampsAreEqualWithSameInfo", testTimestampsAreEqualWithSameInfo),
    ("testTimestampsWithDifferentZonesAreUnequal", testTimestampsWithDifferentZonesAreUnequal),
    ("testTimestampsWithDifferentCalendarsAreUnequal", testTimestampsWithDifferentCalendarsAreUnequal),
  ]}
